...
export const postPatronus = async (evaluator, credentials, data, timeout, criteria = null) => {
    const options = {
        headers: {
...
export function findAllLongestPositions(data) {
    ...
    const longestPositions = data.positions.filter((pos) => pos[1] - pos[0] === maxLength);
    return {
