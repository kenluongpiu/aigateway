...
export const HuggingfaceChatCompleteConfig = {
    model: {
        param: 'model',
    },
    messages: {
...
export const HuggingfaceChatCompleteResponseTransform = (response, responseStatus) => {
...
export const HuggingfaceChatCompleteStreamChunkTransform = (responseChunk) => {
