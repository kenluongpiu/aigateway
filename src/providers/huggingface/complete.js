...
export const HuggingfaceCompleteConfig = {
    model: {
        param: 'model',
    },
    prompt: {
...
export const HuggingfaceCompleteResponseTransform = (response, responseStatus) => {
...
export const HuggingfaceCompleteStreamChunkTransform = (responseChunk) => {
