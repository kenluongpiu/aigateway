...
export const OpenAICompleteConfig = {
    model: {
        param: 'model',
        required: true,
...
export const OpenAICompleteResponseTransform = (response, responseStatus) => {
 ...
 */
export const OpenAICompleteJSONToStreamResponseTransform = (response, provider) => {
