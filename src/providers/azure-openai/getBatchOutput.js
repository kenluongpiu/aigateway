...
export const AzureOpenAIGetBatchOutputRequestHandler = async ({ c, providerOptions, requestURL, }) => {
    ...
    const retrieveBatchURL = baseUrl +
    ...
    const retrieveFileContentURL = baseUrl +
        AzureOpenAIAPIConfig.getEndpoint({
            providerOptions,
