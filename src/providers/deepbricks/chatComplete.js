...
export const DeepbricksChatCompleteConfig = {
    model: {
        param: 'model',
        required: true,
...
export const DeepbricksErrorResponseTransform = (response, provider) => {
    return generateErrorResponse({
        ...response.error,
    }, provider);
};
export const DeepbricksChatCompleteResponseTransform = (response, responseStatus) => {
 ...
 */
export const DeepbricksChatCompleteJSONToStreamResponseTransform = (response, provider) => {
