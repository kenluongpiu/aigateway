...
export const NCompassChatCompleteConfig = {
    model: {
        param: 'model',
        required: true,
...
export const NCompassChatCompleteResponseTransform = (response, responseStatus) => {
...
export const NCompassChatCompleteStreamChunkTransform = (responseChunk) => {
