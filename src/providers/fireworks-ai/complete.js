...
export const FireworksAICompleteConfig = {
    model: {
        param: 'model',
        required: true,
    },
...
export const FireworksAICompleteResponseTransform = (response, responseStatus) => {
...
export const FireworksAICompleteStreamChunkTransform = (responseChunk) => {
