...
export const RekaAIChatCompleteConfig = {
    model: {
        param: 'model_name',
        required: true,
        default: 'reka-flash',
    ...
    messages: {
        ...
        transform: (params) => {
            ...
            params.messages?.forEach((message) => {
                const currentType = message.role === 'user' ? 'human' : 'model';
...
export const RekaAIChatCompleteResponseTransform = (response) => {
