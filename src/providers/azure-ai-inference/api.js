...
import { getAccessTokenFromEntraId, getAzureManagedIdentityToken, } from '../azure-openai/utils';
const AzureAIInferenceAPI = {
    ...
    headers: async ({ providerOptions }) => {
        const { apiKey, azureExtraParams, azureDeploymentName, azureAdToken, azureAuthMode, } = providerOptions;
        const headers = {
