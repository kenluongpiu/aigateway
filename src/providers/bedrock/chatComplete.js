import { BEDROCK, documentMimeTypes, fileExtensionMimeTypeMap, imagesMimeTypes, } from '../../globals';
import { SYSTEM_MESSAGE_ROLES, } from '../../types/requestBody';
import { generateErrorResponse, generateInvalidProviderResponseError, } from '../utils';
import { transformAdditionalModelRequestFields, transformAI21AdditionalModelRequestFields, transformAnthropicAdditionalModelRequestFields, transformCohereAdditionalModelRequestFields, transformInferenceConfig, } from './utils';
const getMessageTextContentArray = (message) => {
...
const transformAndAppendThinkingMessageItem = (item, out) => {
...
const getMessageContent = (message) => {
    ...
    const out = [];
    const inputContent = message.content_blocks ?? message.content;
...
export const BedrockConverseChatCompleteConfig = {
    messages: [
        {
            param: 'messages',
            required: true,
            transform: (params) => {
                ...
                const combinedMessages = transformedMessages.reduce((acc, msg) => {
        ...
        },
        {
            ...
            transform: (params) => {
                if (!params.messages)
                    return;
                const systemMessages = params.messages.reduce((acc, msg) => {
    ...
    max_tokens: {
        ...
        transform: (params) => transformInferenceConfig(params),
    },
    ...
    additionalModelRequestFields: {
        ...
        transform: (params) => transformAdditionalModelRequestFields(params),
    },
...
export const BedrockErrorResponseTransform = (response) => {
    if ('message' in response) {
        return generateErrorResponse({ message: response.message, type: null, param: null, code: null }, BEDROCK);
    }
    return undefined;
};
const transformContentBlocks = (contentBlocks) => {
    const output = [];
...
export const BedrockChatCompleteResponseTransform = (response, responseStatus, responseHeaders, strictOpenAiCompliance, _gatewayRequestUrl, gatewayRequest) => {
    ...
    if ('output' in response) {
        const shouldSendCacheUsage = response.usage.cacheWriteInputTokens ||
...
export const BedrockChatCompleteStreamChunkTransform = (responseChunk, fallbackId, streamState, strictOpenAiCompliance, gatewayRequest) => {
    const parsedChunk = JSON.parse(responseChunk);
    ...
    if (parsedChunk.usage) {
        const shouldSendCacheUsage = parsedChunk.usage.cacheWriteInputTokens ||
            ...
            `data: ${JSON.stringify({
                ...
                usage: {
                    ...
                    ...(shouldSendCacheUsage && {
                        ...
                        cache_creation_input_tokens: parsedChunk.usage.cacheWriteInputTokens,
                    }),
                },
            })}\n\n`,
            `data: [DONE]\n\n`,
...
export const BedrockConverseAnthropicChatCompleteConfig = {
    ...
    additionalModelRequestFields: {
        param: 'additionalModelRequestFields',
        transform: (params) => transformAnthropicAdditionalModelRequestFields(params),
    },
    additional_model_request_fields: {
        param: 'additionalModelRequestFields',
        transform: (params) => transformAnthropicAdditionalModelRequestFields(params),
...
export const BedrockConverseCohereChatCompleteConfig = {
    ...BedrockConverseChatCompleteConfig,
    additionalModelRequestFields: {
        param: 'additionalModelRequestFields',
        transform: (params) => transformCohereAdditionalModelRequestFields(params),
    },
    additional_model_request_fields: {
        param: 'additionalModelRequestFields',
        transform: (params) => transformCohereAdditionalModelRequestFields(params),
...
export const BedrockConverseAI21ChatCompleteConfig = {
    ...BedrockConverseChatCompleteConfig,
    additionalModelRequestFields: {
        param: 'additionalModelRequestFields',
        transform: (params) => transformAI21AdditionalModelRequestFields(params),
    },
    additional_model_request_fields: {
        param: 'additionalModelRequestFields',
        transform: (params) => transformAI21AdditionalModelRequestFields(params),
...
export const BedrockCohereChatCompleteConfig = {
    messages: {
        param: 'prompt',
        required: true,
        transform: (params) => {
...
export const BedrockCohereChatCompleteResponseTransform = (response, responseStatus, responseHeaders, _strictOpenAiCompliance, _gatewayRequestUrl, gatewayRequest) => {
    if (responseStatus !== 200) {
...
export const BedrockCohereChatCompleteStreamChunkTransform = (responseChunk, fallbackId, _streamState, _strictOpenAiCompliance, gatewayRequest) => {
...
export const BedrockAI21ChatCompleteConfig = {
    messages: {
        param: 'prompt',
        required: true,
        transform: (params) => {
...
export const BedrockAI21ChatCompleteResponseTransform = (response, responseStatus, responseHeaders, _strictOpenAiCompliance, _gatewayRequestUrl, gatewayRequest) => {
    if (responseStatus !== 200) {
        const errorResposne = BedrockErrorResponseTransform(response);
        if (errorResposne)
            return errorResposne;
