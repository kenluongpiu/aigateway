...
import { MESSAGE_ROLES, } from '../../types/requestBody';
import { generateErrorResponse, generateInvalidProviderResponseError, } from '../utils';
import { LLAMA_2_SPECIAL_TOKENS, LLAMA_3_SPECIAL_TOKENS, MISTRAL_CONTROL_TOKENS, } from './constants';
import * as z from 'zod';
const transformAssistantMessageForAnthropic = (msg) => {
    const content = [];
...
const transformToolMessageForAnthropic = (msg) => {
    return {
        role: 'user',
        content: [
            {
...
const BedrockAnthropicChatCompleteConfig = {
    messages: [
        {
            param: 'messages',
            required: true,
...
const BedrockCohereChatCompleteConfig = {
    messages: {
        param: 'prompt',
        required: true,
        transform: (params) => {
...
*/
const convertContentTypesToString = (acc, curr) => {
    if (curr.type !== 'text')
        return acc;
    acc += curr.text + '\n';
    return acc;
...
*/
const transformMessagesForLLama3Prompt = (messages) => {
    let prompt = '';
...
/*
  ...
  */
const transformMessagesForLLama2Prompt = (messages) => {
    let finalPrompt = '';
...
/*
  ...
  */
const transformMessagesForMistralPrompt = (messages) => {
...
const BedrockLlama2ChatCompleteConfig = {
    messages: {
        param: 'prompt',
        required: true,
        transform: (params) => {
...
const BedrockLlama3ChatCompleteConfig = {
    messages: {
        param: 'prompt',
        required: true,
        transform: (params) => {
...
const BedrockMistralChatCompleteConfig = {
    messages: {
        param: 'prompt',
        required: true,
        transform: (params) => {
...
const BedrockTitanChatompleteConfig = {
    messages: {
        param: 'inputText',
        required: true,
        transform: (params) => {
...
const BedrockAI21ChatCompleteConfig = {
    messages: {
        param: 'prompt',
        required: true,
        transform: (params) => {
...
export const BedrockLlamaChatCompleteResponseTransform = (response) => {
...
export const BedrockTitanChatCompleteResponseTransform = (response) => {
...
export const BedrockAI21ChatCompleteResponseTransform = (response) => {
...
export const BedrockAnthropicChatCompleteResponseTransform = (response) => {
...
export const BedrockCohereChatCompleteResponseTransform = (response) => {
...
export const BedrockMistralChatCompleteResponseTransform = (response) => {
...
export const BedrockUploadFileTransformerConfig = {
...
export const BedrockUploadFileResponseTransforms = {
...
export const transformFinetuneDatasetLine = (json) => {
...
export const tryChatToTextTransformation = (json) => {
