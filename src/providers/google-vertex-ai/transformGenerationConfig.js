 ...
 */
export function transformGenerationConfig(params) {
...
export function transformEmbeddingsParameters(params) {
    let embeddingsParameters = {};
...
export function transformEmbeddingInputs(params) {
    const instances = [];
