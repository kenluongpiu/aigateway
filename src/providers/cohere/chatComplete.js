...
export const CohereChatCompleteConfig = {
    model: {
        param: 'model',
        default: 'command',
        required: true,
    ...
    messages: [
        ...
        },
        {
            ...
            transform: (params) => {
                ...
                const history = messagesWithoutLastMessage.map((message) => {
                    const _message = {
...
export const CohereChatCompleteResponseTransform = (response, responseStatus) => {
    ...
    return {
        ...
        usage: {
            ...
            total_tokens: Number(response.meta.billed_units.output_tokens +
                response.meta.billed_units.input_tokens),
        },
    };
};
export const CohereChatCompleteStreamChunkTransform = (responseChunk, fallbackId, streamState = { generation_id: '' }, _strictOpenAiCompliance, gatewayRequest) => {
    ...
    return (`data: ${JSON.stringify({
        ...
        ...(parsedChunk.event_type === 'stream-end' && {
            usage: {
                completion_tokens: parsedChunk.response.meta.billed_units.output_tokens,
                prompt_tokens: parsedChunk.response.meta.billed_units.input_tokens,
                total_tokens: Number(parsedChunk.response.meta.billed_units.output_tokens +
        ...
        choices: [
            {
                ...
                logprobs: null,
                finish_reason: parsedChunk.finish_reason ?? null,
            },
        ],
    })}` + '\n\n');
};
