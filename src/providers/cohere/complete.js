...
export const CohereCompleteConfig = {
    model: {
        param: 'model',
        default: 'command',
        required: true,
...
export const CohereCompleteResponseTransform = (response, responseStatus) => {
...
export const CohereCompleteStreamChunkTransform = (responseChunk, fallbackId, _streamState, _strictOpenAiCompliance, gatewayRequest) => {
