import { ANTHROPIC, COHERE, GOOGLE, GOOGLE_VERTEX_AI, PERPLEXITY_AI, DEEPINFRA, SAMBANOVA, BEDROCK, } from './globals';
export const getStreamModeSplitPattern = (proxyProvider, requestURL) => {
    let splitPattern = '\n\n';
...
export const getStreamingMode = (reqBody, provider, requestUrl) => {
    if ([GOOGLE, GOOGLE_VERTEX_AI].includes(provider) &&
...
export function convertKeysToCamelCase(obj, parentKeysToPreserve = []) {
