 ...
 */
export const getBoundaryFromContentType = (contentType) => {
 ...
 */
const transformHeaders = (headers, fieldsMapping) => {
 ...
 */
const enqueueFieldValueAndUpdateBuffer = (chunk, controller, buffer) => {
 ...
 * @returns The updated buffer.
 */
const enqueueFileContentAndUpdateBuffer = (chunk, controller, buffer, rowTransform) => {
 ...
 * @returns The updated buffer.
 */
const enqueueFileContentAndUpdateOctetStreamBuffer = (controller, buffer, rowTransform) => {
 ...
 */
export const getFormdataToFormdataStreamTransformer = (requestHeaders, rowTransform, fieldsMapping) => {
 ...
 * @returns An instance of TransformStream.
 */
export const getOctetStreamToOctetStreamTransformer = (rowTransform) => {
    const decoder = new TextDecoder();
    let buffer = '';
    const transformStream = new TransformStream({
        transform(chunk, controller) {
...
export const formDataToOctetStreamTransformer = (requestHeaders, rowTransform) => {
    const decoder = new TextDecoder();
    const boundary = '--' + getBoundaryFromContentType(requestHeaders['content-type']);
